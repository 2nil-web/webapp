...
2. And to dive a little bit deeper into it, a 'quick and dirty' user documentation and reference is available with the file '[webapp_quick_user_doc_and_reference.md](webapp_quick_user_doc_and_reference.md)'. It basically repeats what is already indicated with the -h/--help and -u options and also what you can test in the folder 'examples/01-test_bed'.  
